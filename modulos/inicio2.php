...
<div id="encabezado" style="height: 150px; width: 1002px; float: left; background-image: url('../../css/flecha.png'); background-repeat: no-repeat; background-position: 20px 30px;">
...
<div id="instrucciones" style="height: 150px; width: 1002px; float: left;">
    ...
    <p class="ins">En esta Secci&oacute;n se ven y se modifican las propiedades de los usuarios.</p>
</div>
