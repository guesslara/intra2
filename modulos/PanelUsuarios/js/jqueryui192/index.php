...
<div id="accordion" style="height: 300px; width: 400px; background: #f0f0f0; overflow: auto;">
	<?
	for($a=0;$a<3;$a++){
	?>
	<h3>cabeza <?=$a;?></h3>
	<div style="border: 1px solid #808080; height: 100px;">
		<div style="height: 50px;">1.<?=$a;?></div>
		<div style="height: 50px;">2.<?=$a;?></div>
		<div style="height: 50px;">3.<?=$a;?></div>
	</div>
	<?}?>
</div>
